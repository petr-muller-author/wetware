...
## [1.0.0](https://github.com/petr-muller/wetware/compare/v0.4.0...v1.0.0) (2026-07-12)
...
* add --date option to wet add command ([#208](https://github.com/petr-muller/wetware/issues/208)) ([9604719](https://github.com/petr-muller/wetware/commit/96047191e84decbba7c03c980d275966f99a329f))
* add `wet config` command with thoughts.order setting ([#216](https://github.com/petr-muller/wetware/issues/216)) ([83a366e](https://github.com/petr-muller/wetware/commit/83a366ed07602e0b7129608477461ae31089ec73))
* add `wet entity rename` command ([#227](https://github.com/petr-muller/wetware/issues/227)) ([ca59ae7](https://github.com/petr-muller/wetware/commit/ca59ae738b07b041fde0dc4f356b1a73342f0e53))
* add ability to delete thoughts from CLI and TUI ([#213](https://github.com/petr-muller/wetware/issues/213)) ([3d47538](https://github.com/petr-muller/wetware/commit/3d475388aaa724c5a8ac83a3521354bd853cfe59))
* add entity descriptions feature ([#178](https://github.com/petr-muller/wetware/issues/178)) ([1b72223](https://github.com/petr-muller/wetware/commit/1b7222328d3ee8e54e4157e023f80ae61b4c341c))
...
* add wet edit command for editing existing thoughts ([#183](https://github.com/petr-muller/wetware/issues/183)) ([71ca5b9](https://github.com/petr-muller/wetware/commit/71ca5b96ebc0842b6483aee201bc6f9a40550aca))
...
* hide time from thought display in CLI and TUI ([#214](https://github.com/petr-muller/wetware/issues/214)) ([ab8d2df](https://github.com/petr-muller/wetware/commit/ab8d2dfa77d7ff0a7c28552662ae69f783b822d3))
...
* **tui:** add interactive TUI thought viewer ([#192](https://github.com/petr-muller/wetware/issues/192)) ([d0264a1](https://github.com/petr-muller/wetware/commit/d0264a1ca27e1729876db700dd9e7fe2a47064d8))
* XDG data directory for storage and config ([#207](https://github.com/petr-muller/wetware/issues/207)) ([30feb28](https://github.com/petr-muller/wetware/commit/30feb28592b662aeb92ac93370c6edc5bbff6dcd))
...
* trim thought content to remove blank lines in CLI output ([#215](https://github.com/petr-muller/wetware/issues/215)) ([3602613](https://github.com/petr-muller/wetware/commit/3602613cd2e1d6e4c090cc70ff851b01555d39e6))
